...
// MockMale is a mock_person of Male interface.
type MockMale struct {
	ctrl     *gomock.Controller
	recorder *MockMaleMockRecorder
}

// MockMaleMockRecorder is the mock_person recorder for MockMale.
type MockMaleMockRecorder struct {
	mock *MockMale
}

// NewMockMale creates a new mock_person instance.
